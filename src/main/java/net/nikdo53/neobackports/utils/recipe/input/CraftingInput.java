...
public class CraftingInput implements RecipeInput {
    ...
    public static CraftingInput fromContainer(CraftingContainer container){
    ...
    public boolean equals(Object other) {
        if (other == this) {
            ...
            return other instanceof CraftingInput craftinginput && this.width == craftinginput.width
                    && this.height == craftinginput.height
                    && this.ingredientCount == craftinginput.ingredientCount
                    && ItemStackBackportExtension.listMatches(this.items, craftinginput.items);
        }
    }

    @Override
    public int hashCode() {
        int i = ItemStackBackportExtension.hashStackList(this.items);
        i = 31 * i + this.width;
