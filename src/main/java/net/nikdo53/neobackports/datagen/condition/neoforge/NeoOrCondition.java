...
public class NeoOrCondition implements ICondition
{
    private static final ResourceLocation NAME = new ResourceLocation("neoforge", "or");
    private final ICondition[] children;

    public NeoOrCondition(ICondition... values)
    {
    ...
    public static class Serializer implements IConditionSerializer<NeoOrCondition>
    {
        public static final Serializer INSTANCE = new Serializer();

        @Override
        public void write(JsonObject json, NeoOrCondition value)
        {
        ...
        @Override
        public NeoOrCondition read(JsonObject json)
        {
            ...
            return new NeoOrCondition(children.toArray(new ICondition[children.size()]));
        }

        @Override
        public ResourceLocation getID()
        {
            return NeoOrCondition.NAME;
        }
    }
}
